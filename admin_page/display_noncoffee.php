...
<div class="product-display">
    ...
    <?php
      $select = mysqli_query($conn, "SELECT * FROM non_coffee");
    ...
    <div class="product-display">
        <table class="product-display-table">
            ...
            <tr>
                ...
                <td>
                    <a href="update products/upnoncoffee.php?edit=<?php echo $row['id']; ?>" class="btn"> <i
                            class="fas fa-edit"></i> edit </a>
                    <a href="display_noncoffee.php?delete=<?php echo $row['id']; ?>" class="btn"> <i
