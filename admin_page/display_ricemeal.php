...
<body>
    ...
    <?php
    $select = mysqli_query($conn, "SELECT * FROM ricemeal");
        ...
        <table class="product-display-table">
            ...
            <?php while ($row = mysqli_fetch_assoc($select)) { ?>
                <tr>
                    ...
                    <td>
                        <a href="update products/upricemeal.php?edit=<?php echo $row['id']; ?>" class="btn"> <i
                                class="fas fa-edit"></i> edit </a>
                        <a href="display_ricemeal.php?delete=<?php echo $row['id']; ?>" class="btn"> <i
