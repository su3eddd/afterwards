...
<body>
    ...
    <?php
    $select = mysqli_query($conn, "SELECT * FROM pastries");
        ...
        <table class="product-display-table">
            ...
            <?php while ($row = mysqli_fetch_assoc($select)) { ?>
                <tr>
                    ...
                    <td>
                        <a href="update products/uppastries.php?edit=<?php echo $row['id']; ?>" class="btn"> <i
                                class="fas fa-edit"></i> edit </a>
                        <a href="display_pastries.php?delete=<?php echo $row['id']; ?>" class="btn"> <i
