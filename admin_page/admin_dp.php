...
<body>
  ...
  <div class="product-display">
    <table class="product-display-table">
      <thead>
        <tr>
          <th><a href="admin_page/display_bestseller.php">Best Seller</a></th>
          <th><a href="admin_page/display_newarrival.php">New Arrival</a></th>
          <th><a href="admin_page/admin_dp.php">Espresso</a></th>
          <th><a href="admin_page/display_houseblend.php">House Blend</a></th>
          <th><a href="admin_page/display_appetizer.php">Appetizer</a></th>
          <th><a href="admin_page/display_noncoffee.php">Non-Coffee</a></th>
          <th><a href="admin_page/display_matcha.php">Matcha Based</a></th>
          <th><a href="admin_page/display_ricemeal.php">Rice Meal</a></th>
          <th><a href="admin_page/display_pastries.php">Pastries</a></th>
        </tr>
      </thead>
    </table>
  </div>
  ...
  <?php
  $select = mysqli_query($conn, "SELECT * FROM espresso");
    ...
    <table class="product-display-table">
      ...
      <?php while ($row = mysqli_fetch_assoc($select)) { ?>
        <tr>
          ...
          <td>
            <a href="update products/upespresso.php?edit=<?php echo $row['id']; ?>" class="btn"> <i
